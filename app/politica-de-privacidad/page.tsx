...
export default function PoliticaPrivacidadPage() {
   return (
      <LegalShell crumb="política de privacidad" title="Política de privacidad">
         ...
         <ul>
            <li>Agendamiento: Cal.com</li>
            <li>Alojamiento web: Vercel</li>
            <li>Analítica: PostHog (servidores en la UE) y Vercel Analytics</li>
            <li>Prevención de abuso: Upstash (limitación de peticiones por IP)</li>
         </ul>
         ...
         <p>
            ...
            garciachaveroadrian@gmail.com, acreditando tu identidad.
         </p>
