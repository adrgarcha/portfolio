...
export default function Projects() {
   return (
      <section className="pt-24 pb-20" id="projects">
         <div className="flex items-center justify-center gap-x-4 py-4 text-secondary">
            <Code2 size={40} />
            <h2 className="font-bold text-4xl">Proyectos</h2>
            <div className="absolute w-full h-[72px] ml-96 bg-foreground border border-r-0 border-secondary rounded-lg rounded-r-none -z-10" />
         </div>
         <div className="flex flex-col items-center gap-y-16 mt-16 mx-32">
            <section className="flex gap-x-8">
               ...
               />
               <div>
                  <h3 className="font-semibold text-3xl">Golgorio - App para la organización de partidos</h3>
            ...
            <section className="flex gap-x-8">
               ...
               />
               <div>
                  <h3 className="font-semibold text-3xl">Memify - Plataforma para la creación de memes</h3>
                  <div className="flex gap-x-2 mt-3 mb-4">
            ...
            <section className="flex gap-x-8">
               ...
               />
               <div>
                  <h3 className="font-semibold text-3xl">Mariwano - Bot de Discord de uso múltiple</h3>
                  <div className="flex gap-x-2 mt-3 mb-4">
...
function TechBadge({ backgroundColor, color = 'black', children }: { backgroundColor: string; color?: string; children: React.ReactNode }) {
   return (
      <div className="flex items-center gap-x-2 px-3 py-px rounded-full text-sm" style={{ backgroundColor, color }}>
         {children}
      </div>
   );
}
